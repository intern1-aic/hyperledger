...
while [[ $T -eq 0 ]]; do
	docker exec $line /bin/sh -c "peer channel create -o orderer4:10050 -c channel4 -f /repo/config/channel4.tx --tls --cafile /repo/config/crypto-config/ordererOrganizations/ai.com/orderers/orderer4.ai.com/msp/tlscacerts/tlsca.ai.com-cert.pem
"
