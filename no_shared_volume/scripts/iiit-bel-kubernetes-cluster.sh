...
echo "please wait, this may take few moments..............."
...
cp -R ./bin/* /repo/config/bin
mkdir -p /repo/config/crt/org1
mkdir -p /repo/config/crt/org2
mkdir -p /repo/config/crt/org3
