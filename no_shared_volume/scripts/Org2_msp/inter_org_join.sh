...
grep "cli-bel-peer0" temp.txt >> temp2.txt
...
while [[ $T -eq 0 ]]; do
	kubectl exec $line -- sh -c "peer channel fetch 0 channel4.block -c channel4 -o orderer4:10050 --tls --cafile /MSP_Org2/config/crypto-config/ordererOrganizations/ai.com/orderers/orderer4.ai.com/msp/tlscacerts/tlsca.ai.com-cert.pem"
