...
while [[ $T -eq 0 ]]; do
	docker exec $line /bin/sh -c "peer channel fetch 0 channel4.block -c channel4 -o orderer4:10050 --tls --cafile /MSP_Org2/config/crypto-config/ordererOrganizations/ai.com/orderers/orderer4.ai.com/msp/tlscacerts/tlsca.ai.com-cert.pem"
